...
// end end
let sectionAbout = document.querySelector(".about-sec");
let aboutAccord = sectionAbout.querySelector(".content");
let accordionArr = aboutAccord.querySelectorAll(".box");
for (let i = 0; i < accordionArr.length; i++) {
  accordionArr[i].addEventListener("click", Accor);
}
function Accor() {
  aboutAccord.querySelector(".active").classList.remove("active");
